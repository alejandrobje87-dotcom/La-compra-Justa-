(() => {
  ...
  var EXTRAS = [
    ...
    { id: "suavizante", emoji: "\u{1F9F4}", label: "Suavizante", category: "Hogar y limpieza", mercadona: 2.2, lidl: 1.9, carrefour: 2.5, dia: 2 },
    { id: "lejia", emoji: "\u{1F9F4}", label: "Lej\xEDa", category: "Hogar y limpieza", mercadona: 1.1, lidl: 0.95, carrefour: 1.25, dia: 1 },
    { id: "limpiacristales", emoji: "\u{1FA9F}", label: "Limpiacristales", category: "Hogar y limpieza", mercadona: 1.5, lidl: 1.3, carrefour: 1.7, dia: 1.4 },
    { id: "friegasuelos", emoji: "\u{1F9F9}", label: "Friegasuelos", category: "Hogar y limpieza", mercadona: 1.8, lidl: 1.55, carrefour: 2, dia: 1.65 },
    { id: "estropajos", emoji: "\u{1F9FD}", label: "Estropajos (pack)", category: "Hogar y limpieza", mercadona: 1.2, lidl: 1, carrefour: 1.35, dia: 1.1 },
    { id: "servilletas", emoji: "\u{1F9FB}", label: "Servilletas", category: "Hogar y limpieza", mercadona: 1, lidl: 0.85, carrefour: 1.15, dia: 0.9 },
    { id: "filmAluminio", emoji: "\u{1F4E6}", label: "Film / papel aluminio", category: "Hogar y limpieza", mercadona: 1.6, lidl: 1.35, carrefour: 1.8, dia: 1.45 },
    { id: "aceiteOliva", emoji: "\u{1FAD2}", label: "Aceite de oliva (1L)", category: "Despensa", mercadona: 8.5, lidl: 7.9, carrefour: 9.2, dia: 8.2 },
    { id: "aceiteGirasol", emoji: "\u{1F33B}", label: "Aceite de girasol (1L)", category: "Despensa", mercadona: 2.2, lidl: 1.95, carrefour: 2.4, dia: 2.05 },
    { id: "sal", emoji: "\u{1F9C2}", label: "Sal", category: "Despensa", mercadona: 0.5, lidl: 0.4, carrefour: 0.6, dia: 0.45 },
    { id: "azucar", emoji: "\u{1F36C}", label: "Az\xFAcar", category: "Despensa", mercadona: 1.2, lidl: 1.05, carrefour: 1.35, dia: 1.1 },
    { id: "harina", emoji: "\u{1F33E}", label: "Harina", category: "Despensa", mercadona: 0.75, lidl: 0.6, carrefour: 0.85, dia: 0.65 },
    { id: "tomateFritoEx", emoji: "\u{1F96B}", label: "Tomate frito", category: "Despensa", mercadona: 1.1, lidl: 0.9, carrefour: 1.25, dia: 1 },
    { id: "tomateTriturado", emoji: "\u{1F96B}", label: "Tomate triturado", category: "Despensa", mercadona: 0.9, lidl: 0.75, carrefour: 1.05, dia: 0.8 },
    { id: "caldoEx", emoji: "\u{1F372}", label: "Caldo (brik)", category: "Despensa", mercadona: 1.3, lidl: 1.1, carrefour: 1.45, dia: 1.2 },
    { id: "atunLatas", emoji: "\u{1F41F}", label: "At\xFAn (pack latas)", category: "Despensa", mercadona: 2.9, lidl: 2.5, carrefour: 3.2, dia: 2.7 },
    { id: "aceitunasEx", emoji: "\u{1FAD2}", label: "Aceitunas (bote)", category: "Despensa", mercadona: 1.4, lidl: 1.2, carrefour: 1.6, dia: 1.3 },
    { id: "vinagre", emoji: "\u{1F9F4}", label: "Vinagre", category: "Despensa", mercadona: 0.8, lidl: 0.65, carrefour: 0.9, dia: 0.7 },
    { id: "especias", emoji: "\u{1F336}\uFE0F", label: "Especias / condimentos", category: "Despensa", mercadona: 1.2, lidl: 1, carrefour: 1.4, dia: 1.1 },
    { id: "cafeSoluble", emoji: "\u2615", label: "Caf\xE9 soluble", category: "Despensa", mercadona: 3.5, lidl: 3, carrefour: 3.9, dia: 3.2 },
    { id: "cacao", emoji: "\u{1F36B}", label: "Cacao en polvo", category: "Despensa", mercadona: 2.4, lidl: 2.1, carrefour: 2.7, dia: 2.2 },
    { id: "mermeladaEx", emoji: "\u{1F353}", label: "Mermelada", category: "Despensa", mercadona: 1.9, lidl: 1.6, carrefour: 2.1, dia: 1.7 },
    { id: "miel", emoji: "\u{1F36F}", label: "Miel", category: "Despensa", mercadona: 3.2, lidl: 2.8, carrefour: 3.6, dia: 3 },
    { id: "gelDucha", emoji: "\u{1F9F4}", label: "Gel de ducha", category: "Higiene", mercadona: 1.8, lidl: 1.55, carrefour: 2, dia: 1.65 },
    { id: "champu", emoji: "\u{1F9F4}", label: "Champ\xFA", category: "Higiene", mercadona: 2.2, lidl: 1.9, carrefour: 2.5, dia: 2 },
    { id: "pastaDientes", emoji: "\u{1FAA5}", label: "Pasta de dientes", category: "Higiene", mercadona: 1.5, lidl: 1.3, carrefour: 1.7, dia: 1.4 },
    { id: "cepilloDientes", emoji: "\u{1FAA5}", label: "Cepillo de dientes", category: "Higiene", mercadona: 1.2, lidl: 1, carrefour: 1.4, dia: 1.1 },
    { id: "desodorante", emoji: "\u{1F9F4}", label: "Desodorante", category: "Higiene", mercadona: 1.9, lidl: 1.6, carrefour: 2.1, dia: 1.7 },
    { id: "papelHigienicoEx", emoji: "\u{1F9FB}", label: "Papel higi\xE9nico (pack)", category: "Higiene", mercadona: 3.5, lidl: 3, carrefour: 3.9, dia: 3.2 },
    { id: "compresas", emoji: "\u{1FA79}", label: "Compresas / tampones", category: "Higiene", mercadona: 2.3, lidl: 2, carrefour: 2.6, dia: 2.1 },
    { id: "maquinillas", emoji: "\u{1FA92}", label: "Maquinillas afeitar", category: "Higiene", mercadona: 2.5, lidl: 2.1, carrefour: 2.8, dia: 2.3 },
    { id: "panales", emoji: "\u{1F476}", label: "Pa\xF1ales (pack)", category: "Higiene", mercadona: 5.5, lidl: 4.8, carrefour: 6.2, dia: 5.1 },
    { id: "toallitas", emoji: "\u{1F9FB}", label: "Toallitas", category: "Higiene", mercadona: 1.6, lidl: 1.35, carrefour: 1.8, dia: 1.45 },
    { id: "peras", emoji: "\u{1F350}", label: "Peras (kg)", category: "Fruta", mercadona: 1.7, lidl: 1.5, carrefour: 1.9, dia: 1.6 },
    { id: "kiwi", emoji: "\u{1F95D}", label: "Kiwis (kg)", category: "Fruta", mercadona: 2.5, lidl: 2.2, carrefour: 2.8, dia: 2.3 },
    { id: "pina", emoji: "\u{1F34D}", label: "Pi\xF1a (unidad)", category: "Fruta", mercadona: 1.9, lidl: 1.65, carrefour: 2.1, dia: 1.75 },
    { id: "limones", emoji: "\u{1F34B}", label: "Limones (kg)", category: "Fruta", mercadona: 1.6, lidl: 1.4, carrefour: 1.8, dia: 1.5 },
    { id: "cerezasEx", emoji: "\u{1F352}", label: "Cerezas (kg)", category: "Fruta", mercadona: 4.5, lidl: 3.9, carrefour: 5, dia: 4.1 },
    { id: "melocoton", emoji: "\u{1F351}", label: "Melocotones (kg)", category: "Fruta", mercadona: 2.2, lidl: 1.9, carrefour: 2.5, dia: 2 },
    { id: "ciruelas", emoji: "\u{1FAD0}", label: "Ciruelas (kg)", category: "Fruta", mercadona: 2.3, lidl: 2, carrefour: 2.6, dia: 2.1 },
    { id: "frutosRojos", emoji: "\u{1FAD0}", label: "Ar\xE1ndanos (tarrina)", category: "Fruta", mercadona: 2.6, lidl: 2.3, carrefour: 2.9, dia: 2.4 },
    { id: "croissants", emoji: "\u{1F950}", label: "Croissants (pack)", category: "Panader\xEDa", mercadona: 2.1, lidl: 1.8, carrefour: 2.3, dia: 1.9 },
    { id: "magdalenas", emoji: "\u{1F9C1}", label: "Magdalenas", category: "Panader\xEDa", mercadona: 1.7, lidl: 1.45, carrefour: 1.9, dia: 1.55 },
    { id: "galletasDesayuno", emoji: "\u{1F36A}", label: "Galletas desayuno", category: "Panader\xEDa", mercadona: 1.6, lidl: 1.35, carrefour: 1.8, dia: 1.45 },
    { id: "panBao", emoji: "\u{1F35E}", label: "Pan de pita / wraps", category: "Panader\xEDa", mercadona: 1.4, lidl: 1.2, carrefour: 1.6, dia: 1.3 },
    { id: "picos", emoji: "\u{1F956}", label: "Picos / colines", category: "Panader\xEDa", mercadona: 1.1, lidl: 0.9, carrefour: 1.25, dia: 1 },
    { id: "yogurGriego", emoji: "\u{1F95B}", label: "Yogur griego (pack)", category: "L\xE1cteos", mercadona: 2, lidl: 1.7, carrefour: 2.2, dia: 1.8 },
    { id: "yogurBebible", emoji: "\u{1F964}", label: "Yogur bebible", category: "L\xE1cteos", mercadona: 1.6, lidl: 1.35, carrefour: 1.8, dia: 1.45 },
    { id: "queso", emoji: "\u{1F9C0}", label: "Queso curado (cu\xF1a)", category: "L\xE1cteos", mercadona: 3.5, lidl: 3, carrefour: 3.9, dia: 3.2 },
    { id: "batidos", emoji: "\u{1F95B}", label: "Batidos", category: "L\xE1cteos", mercadona: 1.5, lidl: 1.3, carrefour: 1.7, dia: 1.4 },
    { id: "nata", emoji: "\u{1F95B}", label: "Nata para cocinar", category: "L\xE1cteos", mercadona: 1.1, lidl: 0.9, carrefour: 1.25, dia: 1 },
    { id: "flan", emoji: "\u{1F36E}", label: "Flan / natillas (pack)", category: "L\xE1cteos", mercadona: 1.6, lidl: 1.35, carrefour: 1.8, dia: 1.45 },
    { id: "doritos", emoji: "\u{1F33D}", label: "Nachos / Doritos", category: "Snacks salados", mercadona: 1.5, lidl: 1.3, carrefour: 1.7, dia: 1.4 },
    { id: "aceitunasSnack", emoji: "\u{1FAD2}", label: "Aceitunas rellenas", category: "Snacks salados", mercadona: 1.3, lidl: 1.1, carrefour: 1.45, dia: 1.2 },
    { id: "quesitos", emoji: "\u{1F9C0}", label: "Quesitos", category: "Snacks salados", mercadona: 1.7, lidl: 1.45, carrefour: 1.9, dia: 1.55 },
    { id: "pistachos", emoji: "\u{1F95C}", label: "Pistachos", category: "Snacks salados", mercadona: 3.2, lidl: 2.8, carrefour: 3.6, dia: 3 },
    { id: "bombones", emoji: "\u{1F36B}", label: "Bombones", category: "Snacks dulces", mercadona: 2.5, lidl: 2.1, carrefour: 2.8, dia: 2.3 },
    { id: "gominolas", emoji: "\u{1F36C}", label: "Gominolas", category: "Snacks dulces", mercadona: 1.3, lidl: 1.1, carrefour: 1.45, dia: 1.2 },
    { id: "tartaEx", emoji: "\u{1F370}", label: "Tarta / postre", category: "Snacks dulces", mercadona: 3, lidl: 2.6, carrefour: 3.3, dia: 2.8 },
    { id: "turron", emoji: "\u{1F36B}", label: "Barritas de cereales", category: "Snacks dulces", mercadona: 1.8, lidl: 1.55, carrefour: 2, dia: 1.65 },
    { id: "refrescoCola", emoji: "\u{1F964}", label: "Cola (2L)", category: "Bebidas", mercadona: 1.5, lidl: 1.3, carrefour: 1.7, dia: 1.4 },
    { id: "tonica", emoji: "\u{1F964}", label: "T\xF3nica / gaseosa", category: "Bebidas", mercadona: 1.4, lidl: 1.2, carrefour: 1.6, dia: 1.3 },
    { id: "teFrio", emoji: "\u{1F9CB}", label: "T\xE9 fr\xEDo", category: "Bebidas", mercadona: 1.3, lidl: 1.1, carrefour: 1.45, dia: 1.2 },
    { id: "isotonica", emoji: "\u{1F964}", label: "Bebida isot\xF3nica", category: "Bebidas", mercadona: 1.2, lidl: 1, carrefour: 1.35, dia: 1.1 },
    { id: "vinoTinto", emoji: "\u{1F377}", label: "Vino tinto (botella)", category: "Bebidas", mercadona: 3.5, lidl: 3, carrefour: 3.9, dia: 3.2 },
    { id: "sidra", emoji: "\u{1F37E}", label: "Sidra / cava", category: "Bebidas", mercadona: 3, lidl: 2.6, carrefour: 3.3, dia: 2.8 },
    { id: "lecheDesayuno", emoji: "\u{1F95B}", label: "Leche (pack 6)", category: "Bebidas", mercadona: 5.4, lidl: 4.8, carrefour: 6, dia: 5 }
  ];
  var EXTRA_CATEGORIES = ["Fruta", "Panader\xEDa", "L\xE1cteos", "Snacks salados", "Snacks dulces", "Bebidas", "Despensa", "Hogar y limpieza", "Higiene"];
  var FOTO_CATEGORIAS = [
    ["crema", ["crema"]],
    ["ensalada", ["ensalada"]],
    ["risotto", ["risotto"]],
...
`;
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { background: "#F4F7F4", color: "#20281F", minHeight: "100vh" }, className: "font-body pb-safe" }, /* @__PURE__ */ React.createElement("style", null, `
        ...
        @media (min-width: 1024px) {
          .app-wide { max-width: 1080px !important; }
        }
    ...
    ))), /* @__PURE__ */ React.createElement("div", { style: { background: "#1FAA59" }, className: "py-4" }, /* @__PURE__ */ React.createElement("div", { className: "max-w-3xl mx-auto px-5 text-center" }, savings > 0 ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", { className: "text-sm", style: { color: "#FFFFFF", opacity: 0.9 } }, "Esta semana, tu compra es m\xE1s barata en ", cheapest.name, ". Ahorras"), /* @__PURE__ */ React.createElement("p", { className: "font-display leading-none mt-1", style: { fontSize: "2.5rem", color: "#FFFFFF" } }, fmt(savings), " \u20AC"), /* @__PURE__ */ React.createElement("p", { className: "text-sm mt-1", style: { color: "#FFFFFF", opacity: 0.9 } }, "frente a comprar en el supermercado m\xE1s caro \u2014 unos ", fmt(savings * 52), " \u20AC al a\xF1o")) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", { className: "font-display text-lg sm:text-xl leading-snug", style: { color: "#FFFFFF" } }, "Descubre en qu\xE9 supermercado tu compra semanal es m\xE1s barata"), /* @__PURE__ */ React.createElement("p", { className: "text-sm mt-1", style: { color: "#FFFFFF", opacity: 0.9 } }, "Men\xFA completo + lista de la compra + el precio real en Mercadona, Lidl, Carrefour y D\xEDa")))), /* @__PURE__ */ React.createElement(
      "nav",
      {
      ...
      return /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, sorted.map((s, i) => {
        const pct = maxTotal > 0 ? s.total / maxTotal * 100 : 0;
        const isCheapest = s.id === cheapest.id;
        const diff = s.total - minTotal;
        return /* @__PURE__ */ React.createElement("div", { key: s.id }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-1" }, /* @__PURE__ */ React.createElement("span", { className: "font-mono text-sm flex items-center gap-2", style: { color: "#20281F" } }, /* @__PURE__ */ React.createElement("span", { style: { fontWeight: isCheapest ? 700 : 500 } }, s.name), isCheapest && /* @__PURE__ */ React.createElement("span", { className: "font-mono px-2 py-0.5 rounded-lg", style: { fontSize: 10, background: "#1FAA59", color: "#FFFFFF" } }, "M\xC1S BARATO")), /* @__PURE__ */ React.createElement("span", { className: "font-mono text-sm font-bold", style: { color: isCheapest ? "#1FAA59" : "#20281F" } }, fmt(s.total), " \u20AC")), /* @__PURE__ */ React.createElement("div", { className: "rounded-full overflow-hidden", style: { background: "#EEF2EE", height: 12 } }, /* @__PURE__ */ React.createElement(
          "div",
          {
            className: "h-full rounded-full",
            style: {
              width: `${pct}%`,
              background: isCheapest ? "#1FAA59" : s.color,
      ...
      "\u203A"
    )), /* @__PURE__ */ React.createElement("div", { className: "space-y-4" }, activeMenu.filter((d) => d.day === selectedDay).map((d) => /* @__PURE__ */ React.createElement("div", { key: d.day }, /* @__PURE__ */ React.createElement("p", { className: "font-mono text-xs uppercase mb-1.5", style: { color: "#1FAA59" } }, d.day), /* @__PURE__ */ React.createElement("div", { className: "space-y-2 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-3" }, ["comida", "cena"].map((mealType) => {
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "space-y-2 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-2 lg:items-start" }, shoppingByCategory.map((cat) => {
